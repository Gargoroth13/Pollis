...
Agency: jogadores escolhem candidatos, votam, governam, fazem oposição e podem contestar o governo.
Simplicidade: eleições utilizam votação direta e o candidato mais votado vence, com segundo turno somente em empate presidencial.
Responsabilidade: ocupar um cargo implica tomar decisões reais e cumprir responsabilidades administrativas.
Separação de funções: Executivo administra; Legislativo participa da criação das leis; Constituição limita ambos.
Transparência: decisões públicas devem poder ser auditadas pelos jogadores.
Continuidade institucional: mudança de governante não apaga leis, orçamento, cidades ou instituições existentes.
Sucessão: o sistema evita vácuos de poder sem transformar toda perda de cargo em uma nova eleição.
Contestação: eleições são o mecanismo normal de mudança; deposição é uma ferramenta extraordinária do sistema de Milícias.
Economia: remuneração e decisões políticas permanecem conectadas à economia e ao orçamento público.
Parâmetros ajustáveis: números de balanceamento devem ser ajustáveis sem redesenhar a estrutura do sistema.
